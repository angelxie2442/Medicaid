...
Cookie = 'ALF=1591853576; SCF=AvtPDhSu1zjergHIUNRflG9NrH1Gk0ZfP7hMmxKMzBBiCM1lzs0TCY-ilpDn0vqouOfkAFAu24Lg85dcPn6CY60.; SUHB=0P1cKa3MWR3BKQ; _T_WM=1ba19e611bad83e1a60162199d109b2f; SSOLoginState=1589262094; SUB=_2A25zvkd3DeRhGeBH41IR8S7PwjuIHXVRQWk_rDV6PUJbktANLXLDkW1NQbh1HAlCzwa4PLnEF8_FiE-D3AcFdhJW; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9W5.MZD534IkG.u4HTZuJ68I5JpX5K-hUgL.Foq41h57eK501KM2dJLoI7Db9gLb9g.EShBE'
...
class WeiboTopicScrapy(Thread):
    ...
    def run(self):
        ...
        for page in range(1, pageNum):
            ...
            #https://www.weibo.com/u/6980010397/home?wvr=5
            #https://weibo.cn/search/mblog
            #res=requests.models.reponse
            print(res.text)#str
...
if __name__ == '__main__':
    ...
    WeiboTopicScrapy(keyword='corona',filter=0,start_time='20200301',end_time='20200302')